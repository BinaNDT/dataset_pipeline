...
with open(annotations_file, 'r') as f:
    for line in f:
        ...
        # We don't need to fetch the DataRow object for prediction creation
        # Just use the ID directly in the prediction object
        ...
        for ann in ann_entry['annotations']:
            ...
            annotation = {
                'schemaId': ann.get('schemaId', ann['name']),
